...
<html>
    ...
    <body>
        <table align="center">
            <tr>
                <td colspan = "2" style="font-weight: bold;size: 70px" align="center"><h3>Alta Usuarios</h3></td>
            </tr>
                ...
                <tr>
                    ...
                    <td  align ="center">
                        <html:select property="tipo">
                            <html:option value="A">Administrador</html:option>
                            <html:option value="V">Vendedor</html:option>
